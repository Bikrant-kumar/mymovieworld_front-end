...
class LoginRegister extends Component{
  ...
  constructor(props){
    ...
    login= e =>{
        e.preventDefault();
        fire.auth().signInWithEmailAndPassword(this.state.email,this.state.password).then( this.props.history.push("/home") )     
            .catch((error)=>{
    ...
    register= e =>{
        e.preventDefault();
        fire.auth().createUserWithEmailAndPassword(this.state.email,this.state.password).then( this.props.history.push("/home") ) 
            .catch((error)=>{
                this.setState({fireErrors:error.message})
                window.alert(error.message); 
                this.props.history.push("/"); 
